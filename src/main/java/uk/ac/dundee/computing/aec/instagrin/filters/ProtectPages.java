 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/upload.jsp", "/editProfile/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
